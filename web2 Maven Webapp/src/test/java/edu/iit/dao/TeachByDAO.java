...
/**
 	* A data access object (DAO) providing persistence and search support for TeachBy entities.
...
public class TeachByDAO extends BaseHibernateDAO  {
    ...
    public TeachBy findById( edu.iit.dao.TeachById id) {
        ...
        try {
            TeachBy instance = (TeachBy) getSession()
                    .get("edu.iit.dao.TeachBy", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(TeachBy instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("edu.iit.dao.TeachBy")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TeachBy instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from TeachBy as model where model." 
         						+ propertyName + "= ?";
    ...
    public TeachBy merge(TeachBy detachedInstance) {
        ...
        try {
            TeachBy result = (TeachBy) getSession()
