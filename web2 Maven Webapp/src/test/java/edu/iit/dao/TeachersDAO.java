...
/**
 	* A data access object (DAO) providing persistence and search support for Teachers entities.
...
public class TeachersDAO extends BaseHibernateDAO  {
    ...
    public Teachers findById( java.lang.Integer id) {
        ...
        try {
            Teachers instance = (Teachers) getSession()
                    .get("edu.iit.dao.Teachers", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Teachers instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("edu.iit.dao.Teachers")
    ...
    public Teachers merge(Teachers detachedInstance) {
        ...
        try {
            Teachers result = (Teachers) getSession()
