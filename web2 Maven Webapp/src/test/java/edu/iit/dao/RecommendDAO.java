...
/**
 	* A data access object (DAO) providing persistence and search support for Recommend entities.
...
public class RecommendDAO extends BaseHibernateDAO  {
    ...
    public Recommend findById( edu.iit.dao.RecommendId id) {
        ...
        try {
            Recommend instance = (Recommend) getSession()
                    .get("edu.iit.dao.Recommend", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Recommend instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("edu.iit.dao.Recommend")
    ...
    public Recommend merge(Recommend detachedInstance) {
        ...
        try {
            Recommend result = (Recommend) getSession()
