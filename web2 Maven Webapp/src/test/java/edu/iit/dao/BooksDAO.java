...
/**
 	* A data access object (DAO) providing persistence and search support for Books entities.
...
public class BooksDAO extends BaseHibernateDAO  {
    ...
    public Books findById( java.lang.Integer id) {
        ...
        try {
            Books instance = (Books) getSession()
                    .get("edu.iit.dao.Books", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Books instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("edu.iit.dao.Books")
