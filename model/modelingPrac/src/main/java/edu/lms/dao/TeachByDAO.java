...
import edu.lms.bean.TeachBy;
import edu.lms.bean.TeachById;
 ...
 * 
 * @see edu.lms.bean.TeachBy
 * @author MyEclipse Persistence Tools
 */
public class TeachByDAO extends TempletDAO {
	...
	public TeachBy findById(edu.lms.bean.TeachById id) {
		log.debug("getting TeachBy instance with id: " + id);
		try {
			TeachBy instance = (TeachBy) getSession().get("edu.lms.bean.TeachBy", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<TeachBy> findByExample(TeachBy instance) {
		log.debug("finding TeachBy instance by example");
		try {
			List<TeachBy> results = (List<TeachBy>) getSession().createCriteria("edu.lms.bean.TeachBy")
