...
public class Parents implements java.io.Serializable {
	...
	/** minimal constructor */
	public Parents(ParentsId id, Student student, String moblie, String email, String relationship, String power) {
		this.id = id;
	...
	/** full constructor */
	public Parents(ParentsId id, Student student, String address, String moblie, String email, String middleName,
